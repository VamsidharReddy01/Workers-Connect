...
class WorkImageAdminTests(AdminSeleniumTestCase):
    ...
    def test_image_changelist_shows_columns(self):
        ...
        self.assertIn('CAPTION', header_text.upper())
        self.assertIn('SORT ORDER', header_text.upper())
        self.assertIn('CREATED AT', header_text.upper())
    ...
    def test_filter_image_by_created_at(self):
        ...
        self.assertIn('By created at', self.browser.find_element(By.ID, 'changelist-filter').text)
    ...
    def test_image_worker_column_display(self):
        ...
        self.navigate_to_changelist('workers', 'workerworkimage')
        rows = self.get_table_rows()
        self.assertIn("worker1", rows[0].text)
    ...
    def test_image_changelist_has_add_button(self):
        ...
        self.navigate_to_changelist('workers', 'workerworkimage')
        add_btn = self.wait_for_element(By.CSS_SELECTOR, '.addlink')
        self.assertIn('Add', add_btn.text)
